...
import {captureDb,queueDraft,listDrafts,discardDraft,flushDrafts,retryDraft,type CaptureDraft} from '../../src/capture/offline'
...
beforeEach(async()=>{await captureDb.drafts.clear();api.owner='owner-one';api.rpc.mockReset().mockResolvedValue({data:'receipt',error:null});Object.defineProperty(globalThis,'navigator',{value:{onLine:true},configurable:true})})
describe('outbox',()=>{
