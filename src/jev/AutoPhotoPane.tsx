...
export default function AutoPhotoPane({products,membership,owner,onSaved,onError}:Props){
 ...
 const liveDecoder=useRef<ReturnType<typeof barcodeClient>|null>(null),scanTimer=useRef<number|undefined>(),drainTimer=useRef<number|undefined>(),lastAccepted=useRef<{code:string;at:number}|null>(null),lastCaptureAt=useRef(0),cameraActive=useRef(false)
